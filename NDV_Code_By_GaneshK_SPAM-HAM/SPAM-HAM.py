...
try:
    df = pd.read_csv('spamhamdata.csv', sep=',') # Try with comma
except Exception as e:
    print(f"Error reading with comma: {e}")
    try:
        df = pd.read_csv('spamhamdata.csv', sep='\t') # Try with tab
    except Exception as e:
        print(f"Error reading with tab: {e}")
        try:
            df = pd.read_csv('spamhamdata.csv', sep=';') # Try with semicolon
        except Exception as e:
            print(f"Error reading with semicolon: {e}")
            print("Could not read the CSV with common delimiters. Please check the file and specify the correct delimiter.")
...
if df is not None:
    ...
    # Check if 'label' and 'text' columns exist before proceeding
    if 'label' in df.columns and 'text' in df.columns:
        ...
        print("Error: 'label' or 'text' columns not found in the DataFrame.")
